...
def get_radar_chart(input_data):
    ...
    fig.add_trace(go.Scatterpolar(
        r=[
            input_data['radius_se'], input_data['texture_se'], input_data['perimeter_se'], input_data['radius_se'], input_data['smoothness_se'], input_data['compactness_se'], input_data['concavity_se'], input_data['concave points_se'], input_data['symmetry_se'], input_data['fractal_dimension_se'], 
        ],
        theta=categories,
        fill='toself',
        name='Standard Error'
...
def add_predictions(input_data):
    ...
    st.write("This app should not be used as a substitute for a professional diagnosis.")
...
def main():
    ...
    with st.container():
        ...
        st.write("Use this app with your cytology lab data to help assess breast cancer from tissue samples. A machine learning model predicts whether the mass is benign or malignant, and you can adjust the measurements manually using the sliders in the sidebar.")
